...
def main() -> int:
    ...
    parser.add_argument("--workload-profile", default="configs/workloads/mixed.json", help="Single workload profile to optimize.")
    parser.add_argument("--queries", type=int, default=128, help="Queries for measured schema-search tuning.")
