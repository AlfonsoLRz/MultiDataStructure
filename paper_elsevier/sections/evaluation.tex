...
% All numbers in this section come from the held-out battery of 2026-07-29
% (results/eval_traces/v2 and results/eval_traces/matrix, committed alongside the
% sources). Reproduction: scripts/run_experiment_battery_v2.ps1 and
% scripts/run_matrix_heatmap.ps1; protocol details in testing.md.
